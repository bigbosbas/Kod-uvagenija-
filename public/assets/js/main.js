// Доступ к PDF по приватному токену (?access=токен из админки либо из
...
const ACCESS_TOKEN_STORAGE_KEY = "kodAccessToken";
...
function showDownload(downloadUrl) {
  ...
  overlayText.textContent = "Ссылка на скачивание готова.";
  overlayLink.href = downloadUrl;
...
const legalDocs = {
  oferta: { src: "assets/legal/oferta.html", title: "Договор публичной оферты" },
  privacy: { src: "assets/legal/privacy-policy.html", title: "Политика обработки персональных данных" },
};
